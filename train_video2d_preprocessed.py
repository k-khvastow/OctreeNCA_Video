...
from src.datasets.Dataset_Video2D_cached import Video2DDatasetCached as Video2DDataset
...
def get_study_config():
    study_config = {
        'experiment.name': r'OctreeNCA_Video2D_6Class',
        'experiment.description': 'Training OctreeNCA on 2D video slices from OCTA dataset with 6 classes.',
