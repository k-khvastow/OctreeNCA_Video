...
def get_study_config():
    ...
    study_config['model.octree.res_and_steps'] = [
        [[400, 400], steps],
        [[200, 200], steps],
        [[100, 100], steps],
        [[50, 50], steps],
    ...
    study_config['trainer.losses'] = [
        "src.losses.DiceLoss.nnUNetSoftDiceLoss",
    ...
    study_config['experiment.name'] = f"WarmStart_M1Init_{random_word}_{study_config['model.channel_n']}"
